...
class _NotepadDetailsState extends State<NotepadDetails>
{
  ...
  Widget build(BuildContext context)
  {
    ...
    return Consumer<NotepadModel>(
        builder: (context, notepadModel, _)
        {
          return Scaffold(
              appBar: AppBar(
                                ...
                                Padding(
                                  ...
                                  child: ElevatedButton.icon(onPressed: () {
                                    if (_formKey.currentState?.validate() ?? false)
                                    {
                                      ...
                                      notepad.date = int.parse(dateController.text); //good code would validate these
                                      notepad.details = detailsController.text; //good code would validate these
