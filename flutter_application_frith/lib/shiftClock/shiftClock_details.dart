...
import 'package:flutter_application_frith/shiftClock/shiftClock.dart';
...
class _GuardClockDetailsState extends State<GuardClockDetails> {
  ...
  Widget build(BuildContext context) {
    _this = this;
    var business = Provider.of<ShiftClockModel>(context, listen: false).items;
    ...
    return Consumer<ShiftClockModel>(builder: (context, notepadModel, _) {
      return Scaffold(
          appBar: AppBar(
